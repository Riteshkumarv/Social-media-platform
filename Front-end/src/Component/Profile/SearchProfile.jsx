...
export default function SearchProfile() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch(() => setError("Error fetching user ID"));
  }, [email]);
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          <div style={menuStyle(false)} onClick={() => navigate("/home")}>
            <FaHome /> Home
          </div>
          <div style={menuStyle(true)}>
            <FaSearch /> Search
          </div>
          <div style={menuStyle(false)} onClick={() => navigate("/add-post")}>
            <FaPlusSquare /> Add Post
          </div>
          <div style={menuStyle(false)} onClick={() => navigate("/profile")}>
        ...
        <div style={{ flex: 1, padding: "20px" }}>
          ...
          {user && (
            <>
              ...
              <h3 style={{ marginTop: "30px" }}>Posts by {user.name}</h3>
              {posts.length > 0 ? (
                <div
                  style={{
                    display: "grid",
